<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutMaster.Master" AutoEventWireup="true" CodeBehind="ListaConvidadosAjax.aspx.cs" Inherits="Projeto02_CadastroEventos.ListaConvidadosAjax" %>
                    ...
                    <div class="col-md-4">                
                        ...
                        <div>  <%--class="form-row"--%>
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    <asp:DropDownList ID="eventoDropDownList" runat="server" CssClass="form-control" AutoPostBack="True" OnSelectedIndexChanged="eventoDropDownList_SelectedIndexChanged"></asp:DropDownList>
                                </div>
                            </div>
